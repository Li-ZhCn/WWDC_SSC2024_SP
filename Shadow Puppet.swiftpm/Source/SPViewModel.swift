...
//        "Forest" : RadialGradient(colors: [Color("bgForestGrad1"), Color("bgForestGrad2")], center: .center, startRadius: 10, endRadius: UIScreen.main.bounds.width * 0.5)
    ]
    ...
    let shadowFontSmall: Font = .system(size: 16, weight: .black, design: .serif)
        .width(.expanded)
...
//    let animationQuick: Animation = .easeInOut(duration: 2)
    ...
    @Published var puppetBlur: Double = 0
